		...
		"import/no-unresolved": [
			"error",
			{
				ignore: [
					...
					"^@yoast/(ui-library|schema-blocks|style-guide|components|helpers|search-metadata-previews|social-metadata-forms|replacement-variable-editor|analysis-report)$",
